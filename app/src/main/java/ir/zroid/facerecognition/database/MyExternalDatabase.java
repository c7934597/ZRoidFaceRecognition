...
public class MyExternalDatabase extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "marzbani.db";
    private static final int DATABASE_VERSION = 1;

    public MyExternalDatabase(Context context) {
        super(context, DATABASE_NAME, ZRoidFile.BACKUP_PATH, null, DATABASE_VERSION);
